...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xanlyznb", {
        method: "POST",
        headers: {
            ...
            <div className="pt-8">
              ...
              <div className="flex justify-center space-x-5">
                ...
                <div className="p-3 rounded-full border border-foreground hover:bg-[#FF0000] hover:border-0 hover:scale-110">
                    <a href="https://youtube.com/@sahasrakasachin" target="_blank">
